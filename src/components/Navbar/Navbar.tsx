...
export function Navbar({ onOpenCart }: NavbarProps) {
  ...
  // Obtém a quantidade real de itens do Zustand
  const totalItems = useCartStore((state) => state.getTotalItems())
  const wishlistCount = 2 // Pode ser conectado com store de favoritos no futuro
    ...
    <header className="w-full bg-black border-b border-zinc-800 text-zinc-100 sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {/* Carrinho de Compras Dourado com a contagem do Zustand */}
          <button
            onClick={onOpenCart}
